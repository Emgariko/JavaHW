...
public class RunMe {
    ...
    private static void key4(final byte[] password) {
        ...
        //long result = 287636610L + (968743489L) << 32;
        //print(4, result, password);
        long result = 2348327483270483243L;
        //null-abstract-Throwable-throw-void-Integer
        print(4, result, password);
        /*for (long i = Integer.MIN_VALUE; i < Integer.MAX_VALUE; i++){
            if ((i) << 32) ^ (i) == 2348327482723738188L){
                print(4, Long.intValue(i) << 32);
                break;
            }
        }*/
    ...
    private static void key5(final byte[] password) {
        ...
        /*for (long i = 1; i < 1e18; i++){
            long x = i * PRIME;
            result = (result + x + x / 2 + x / 3) % PRIME;
            if (x >= 1000_000_000_000_000L){
                break;
            }
        }*/
